  ...
  return (
    ...
    <div className={styles['page-contents']}>
     ...
     <div className={styles['bg-images']}>
       ...
       />
        <img
         src={require('../../../public/images/gem-min.png')}
         loading="lazy"
         sizes="(max-width: 1439px) 100vw, 2000px"
         data-w-id="a58aac5b-a456-deaf-7a69-c79c41b480ee"
         className={styles['headerbg-image-gem']}
       />
       <img
         src={require('../../../public/images/element3-min.png')}
         loading="lazy"
  ...
  return (
    <div className={styles['seye-bot-container']}>
      <div className={styles['seye-bot-wrapper']}>
        ...
        <p>Bot For People Who Want More</p>
    ...
    <div id="description" className={styles['seye-description-container']}>
      <div className={styles['seye-description-wrapper']}>
        <div className={styles['description-text-container']}>
          <h1>Timeless When Only The Best Will Do</h1>
          <hr className={styles['hr']} />
          <p>
            Seye-Bot is a <span>Grid Trading Bot</span> that uses{' '}
            ...
            <span>SMA Crossover, RSI, MACD, and ATR</span>. Seye-Bot
            works based on compound interest and projected annual earnings of{' '}
            <span>150% - 300%</span>. <br/><br/> <sup>*This bot has no stoploss and you may lose all the principal in your account due to severe market fluctuations and other reasons.</sup>
          </p>
        </div>
        {/* <div
        ...
        <div className={styles['progress-bar-container']}>
          <div>
            <div className={styles['progress-bar']}>
              <ChangingProgressProvider values={[300]}>
                {percentage => (
                  <CircularProgressbar
                  styles={buildStyles({
        ...
        <div className={styles['description-text-container']}>
          ...
          {/* <iframe
            ...
            <a href="https://www.myfxbook.com/members/jiasheng98/seye-bot/9562290"><img className={styles['iframe-graph']} alt="widget" src="https://widgets.myfxbook.com/custom-widget?id=9562290&width=400&height=250&bart=0&linet=0&symbol=CADCHF&magic=-1&title=Seye-Bot&nbsp;(Min-Deposit: $300)&titles=14&bgColor=ffffff&gridColor=bdbdbd&lineColor=ff0505&barColor=ffadad&bar1Color=ffadad&fontColor=525252&chartbgc=ffffff&equityColor=eff45a"/></a>
    ...
    <div id="guide" className={styles['seye-guide-container']}>
      <div className={styles['seye-guide-wrapper']}>
        <div className={styles['guide-text-container']}>
          {/* <h1>Please message us if you are interested.</h1> */}
          {/* <span>Please message us if you are interested.</span> */}
            <h1>Take The Pill</h1>
          <div className={styles['guide-step-container']}>
            <Button
              ...
              <div>Open an account on Roboforex (Min-deposit: 300 USD)</div>
              <div>
            ...
            <Collapse in={open}>
              <div id="example-fade-text" className={styles['guide-collapse']}>
                ...
                <br />- Choose <span>'MT4 Cent Affiliate'</span> for account type
          ...
          <div className={styles['guide-step-container']}>
            ...
            <Collapse in={opentwo}>
              <div id="example-fade-text" className={styles['guide-collapse']}>
                - Proceed to deposit a minumum of <span>300 USD</span> to your
                trading account
          ...
          <div className={styles['guide-step-container']}>
            ...
            <Collapse in={openthree}>
              <div id="example-fade-text" className={styles['guide-collapse']}>
                ...
                <a
                  target="_blank"
                  href="https://my.roboforex.com/register-copyfx/?trader=175620">
                  here
                </a>
                <br/>
    ...
    <div className={styles['seye-available-container']}>
      <div className={styles['seye-nfa-wrapper']}>
       ...
       <div>
        ...
        <div>
          <a
          href='https://www.mql5.com/en/signals/1585702'
          target='_blank'
          style={{cursor: 'pointer'}}
          >
    <img
        ...
        <div>
          <a
          href='https://www.followme.com/u/751192/9'
          target='_blank'
          style={{cursor: 'pointer'}}
          >
          <img
